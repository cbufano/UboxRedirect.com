    ...
    <>
      ...
      <section className="bg-navy text-white">
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-20">
          <h1 className="text-4xl font-bold leading-tight md:text-5xl">{t('terms.title')}</h1>
          <p className="mt-4 text-sm text-white/70">{t('terms.updated')}</p>
        </div>
      </section>
