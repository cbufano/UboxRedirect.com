 ...
 * Porta 1:1 de `src/services/privacyService.ts` (site). Mesma convenção de
 * packageService: currentUserId local, mapeamento para camelCase,
 * `throw new Error(error.message)` em erro de Supabase. Cliente só insere e
 * lê os PRÓPRIOS pedidos — RLS (data_requests_select_own_or_staff,
