/**
 * packageService — pré-alertas (expected_packages), pacotes recebidos
 * (packages) e consolidações (consolidations) do usuário logado. Escrita de
...
export const packageService = {
   ...
   * a tela Overview/Shipments usa esse valor só para exibição; o preço
   * realmente cobrado é recalculado no servidor pela Edge Function de
   * pagamento.
   */
